...
"use strict"; // камень-ножницы-бумага
...
function onResize(entries) {
  var aspectRatio = entries[0].contentRect.width / entries[0].contentRect.height;
...
initialData(); //Выбор игрока, включение иконок
...
function resultsBase(innerObj) {
  id += 1;
  dataBase.push(_objectSpread(_objectSpread({}, {
    id: id
  }), innerObj));
  return dataBase;
